...
\begin{itemize}
\item \texttt{alarm.c}, le réveil % #### CHANGER LE NOM ####
...
Pour compiler \texttt{alarm.c}, allez dans le dossier \texttt{PIChorloge/programme/} et tapez la commande \texttt{make alarm} dans le terminal.
...
Dans le terminal, tapez les commandes suivantes pour vous connecter au routeur et transférer le fichier \texttt{alarm.hex} au PIC~:
\begin{verbatim}
